          ...
          <div class="modal-body" id="modal-body">
            ...
            <div id="selelects-pockets">
              ...
              <select id="estado" name="estado">
                ...
                <option value="EspiritoSanto" class="Brasil">Espírito Santo</option>
                <option value="Goias" class="Brasil">Goiás</option>
                ...
                <option value="Para" class="Brasil">Pará</option>
                <option value="Paraiba" class="Brasil">Paraíba</option>
                <option value="Parana" class="Brasil">Paraná</option>
                <option value="Pernambuco" class="Brasil">Pernambuco</option>
                <option value="Piaui" class="Brasil">Piauí</option>
                ...
                <option value="SantaFe-Rosario" class="Argentina">Santa Fé- Rosário</option>
                <option value="Santiago" class="Chile">Santiago</option>
                <option value="SaoPaulo" class="Brasil">São Paulo</option>
              ...
              <select id="univ" name="univ">
                ...
                <option value="CentroFederaldeEducacaoTecnologicaCelsoSuckowdaFonseca" class="RiodeJaneiro">Centro Federal de Educação Tecnológica Celso Suckow da Fonseca</option>
                <option value="CentrouniversitarioarmandoAlvarespenteado-FAAP" class="SaoPaulo">Centro universitário armando Álvares penteado - FAAP</option>
                <option value="Centrouniversitarioavantis" class="SantaCatarina">Centro universitário avantis</option>
                <option value="CentroUniversitarioBaraodeMaua" class="SaoPaulo">Centro Universitário Barão de Mauá </option>
                <option value="CentroUniversitarioBrasileiroUNIBRA" class="Pernambuco">Centro Universitário Brasileiro UNIBRA</option>
                <option value="CentroUniversitarioBrazCubas" class="SaoPaulo">Centro Universitário Braz Cubas</option>
                <option value="CentrouniversitariodasAmericas" class="SaoPaulo">Centro universitário das Américas </option>
                <option value="Centrouniversitariodaserragaucha" class="RioGrandedoSul">Centro universitário da serra gaúcha </option>
                <option value="CentroUniversitariodeBeloHorizonte" class="MinasGerais">Centro Universitário de Belo Horizonte</option>
                <option value="CentrouniversitariodeJoaopessoa" class="Paraiba">Centro universitário de João pessoa </option>
                <option value="CentrouniversitariodeValenca" class="RiodeJaneiro">Centro universitário de Valença </option>
                <option value="CentroUniversitariodeVarzeaGrande" class="MatoGrosso">Centro Universitário de Várzea Grande</option>
                <option value="CentroUniversitariodoEspiritoSanto" class="EspiritoSanto">Centro Universitário do Espírito Santo </option>
                <option value="CentrouniversitarioFaculdadeGuanambi" class="Bahia">Centro universitário Faculdade Guanambi </option>
                <option value="CentroUniversitarioFundacaoAssisGurgacz" class="Parana">Centro Universitário Fundação Assis Gurgacz </option>
                <option value="CentroUniversitarioInga" class="Parana">Centro Universitário Ingá </option>
                <option value="Centrouniversitarioluteranodepalmas" class="Tocantins">Centro universitário luterano de palmas </option>
                <option value="CentroUniversitarioRitterdosReis" class="RioGrandedoSul">Centro Universitário Ritter dos Reis</option>
                <option value="CentrouniversitarioSantanna" class="SaoPaulo">Centro universitário Santanna </option>
                <option value="Centrouniversitariosudoestepaulista" class="SaoPaulo">Centro universitário sudoeste paulista </option>
                <option value="CentroUniversitarioUnigranCapital" class="MatoGrossodoSul">Centro Universitário Unigran Capital </option>
                <option value="CentroUniversitarioUverse" class="Acre">Centro Universitário Uverse</option>
                ...
                <option value="EstaciodeSa" class="RiodeJaneiro">Estácio de Sa</option>
                <option value="FaculdadedecienciasagrariaseexatasdePrimaveradoLeste(UNIC)" class="MatoGrosso">Faculdade de ciências agrárias e exatas de Primavera do Leste (UNIC)</option>
                <option value="FaculdadedecienciasmedicasdesaoJosedoscampos" class="SaoPaulo">Faculdade de ciências médicas de são José dos campos</option>
                <option value="FaculdadedeEducacaodaUniversidadedeSaoPaulo" class="SaoPaulo">Faculdade de Educação da Universidade de São Paulo </option>
                <option value="FaculdadedeEngenhariaseArquitetura" class="Parana">Faculdade de Engenharias e Arquitetura</option>
                <option value="FaculdadedeMedicinadaUniversidadedeSaoPaulo" class="SaoPaulo">Faculdade de Medicina da Universidade de São Paulo </option>
                <option value="FaculdadedeMedicinadeCampos" class="RiodeJaneiro">Faculdade de Medicina de Campos </option>
                <option value="Faculdadedemedicinadepetropolis" class="RiodeJaneiro">Faculdade de medicina de petrópolis </option>
                <option value="FaculdadedeTecnologiadeSaoPaulo-FatecCotia" class="SaoPaulo">Faculdade de Tecnologia de São Paulo - Fatec Cotia</option>
                ...
                <option value="InstitutoFederaldeSantaCatarina-CampusArarangua" class="SantaCatarina">Instituto Federal de Santa Catarina - Campus Araranguá</option>
                <option value="MadonnaUniversity" class="CiLivoniaMichigan">Madonna University</option>
                <option value="MODULO-CARAGUATATUBA" class="SaoPaulo">MÓDULO - CARAGUATATUBA </option>
                <option value="MortonCollege" class="CiciruIllinois">Morton College </option>
                <option value="PontificiaUniversidadeCatolica" class="MinasGerais">Pontifícia Universidade Católica </option>
                <option value="PontificiaUniversidadeCatolica" class="Parana">Pontifícia Universidade Católica </option>
                <option value="PontificiaUniversidadeCatolica" class="SaoPaulo">Pontifícia Universidade Católica </option>
                ...
                <option value="UEPA-UniversidadedoEstadodoPara-Reitoria" class="Para">UEPA - Universidade do Estado do Pará - Reitoria</option>
                <option value="Unifev-CentroUniversitariodeVotuporanga" class="SaoPaulo">Unifev - Centro Universitário de Votuporanga</option>
                <option value="UNIFTC" class="Bahia">UNIFTC</option>
                <option value="UNIGRAN-CentroUniversitariodaGrandeDourados" class="MatoGrossodoSul">UNIGRAN - Centro Universitário da Grande Dourados </option>
                ...
                <option value="UniversidadeCatolicadeSantos" class="SaoPaulo">Universidade Católica de Santos </option>
                <option value="UniversidadeCatolicaDomBosco" class="MatoGrossodoSul">Universidade Católica Dom Bosco </option>
                <option value="UniversidadecatolicadoSalvador" class="Bahia">Universidade católica do Salvador </option>
                <option value="UniversidadeCidadeSaoPaulo" class="SaoPaulo">Universidade Cidade São Paulo</option>
                ...
                <option value="UniversidadedeSaoPaulo" class="SaoPaulo">Universidade de São Paulo</option>
                ...
                <option value="UniversidadeEstaciodeSa" class="RiodeJaneiro">Universidade Estácio de Sá</option>
                ...
                <option value="UniversidadeestadualpaulistaJuliodeMesquitaFilho" class="SaoPaulo">Universidade estadual paulista Júlio de Mesquita Filho</option>
                ...
                <option value="UniversidadefederaldeSaoPaulo" class="SaoPaulo">Universidade federal de São Paulo </option>
                <option value="UniversidadeFederaldeSaoPaulo" class="SaoPaulo">Universidade Federal de São Paulo</option>
                ...
                <option value="UniversidadeFederaldoPara" class="Para">Universidade Federal do Pará </option>
                ...
                <option value="UniversidadeFederaldoTrianguloMineiro" class="MinasGerais">Universidade Federal do Triângulo Mineiro</option>
                ...
                <option value="UniversidadeFederalRuraldoSemi-Arido" class="RioGrandedoNorte">Universidade Federal Rural do Semi-Árido </option>
                <option value="UniversidadeFeevale" class="RioGrandedoSul">Universidade Feevale</option>
                <option value="UniversidadeFiladelfiaLondrina" class="Parana">Universidade Filadélfia Londrina </option>
                ...
                <option value="UniversidadePitagorasUnopar" class="Parana">Universidade Pitágoras Unopar </option>
                ...
                <option value="UniversidadeSaoJudasTadeu" class="SaoPaulo">Universidade São Judas Tadeu </option>
                <option value="UniversidadeTecnologicaFederaldoParana" class="Parana">Universidade Tecnológica Federal do Paraná</option>
                ...
                <option value="UniversitariafederaldeMatoGrosso" class="MatoGrosso">Universitária federal de Mato Grosso </option>
                <option value="Universitarioluteranadobrasil" class="RioGrandedoSul">Universitário luterana do brasil</option>
              ...
              <ul id="lider" name="lider">
                ...
                <li class="UniversidadeFederaldoTocantins">Ana Beatriz Rodrigues Assunção  <span>@anabrassuncao </span></li>
                ...
                <li class="CentroUniversitarioBaraodeMaua">Ana Luísa  da Silva  <span>@anasilva_lu</span></li>
                ...
                <li class="UniversidadeFederaldeMinasGerais">Áquila  Lopes <span>@aquilalopes77</span></li>
                ...
                <li class="Centrouniversitarioavantis">Brunna Letícia Viana Santiago Silva  Viana <span>@brunnaleticia_</span></li>
                ...
                <li class="ESPM">Danton Lourenço <span>@Danton.lou</span></li>
                ...
                <li class="UniversidadeFederalRuraldoSemi-Arido">Eduarda  Mélo <span>@eduarda_mirelle</span></li>
                <li class="Unifev-CentroUniversitariodeVotuporanga">erica Clemente da Silva <span>@erica.clemente</span></li>
                <li class="CentroUniversitarioUverse">Éxilei Costa <span>@exileicosta</span></li>
                ...
                <li class="FaculdadedecienciasagrariaseexatasdePrimaveradoLeste(UNIC)">Gabriela  Araújo Gonçalves de Souza  <span>@araujogs16</span></li>
                ...
                <li class="UniversidadedePernambuco">Giovanna  Arruda Magalhães  <span>@giomags</span></li>
                ...
                <li class="UniversidadeFederaldeMatoGrossodoSul">Gustavo Felipe  Gonçalves Reis <span>@gustavoreis.png</span></li>
                ...
                <li class="FaculdadedeEducacaodaUniversidadedeSaoPaulo">Jaqueline  Araújo da Silva  <span>@jajaquearaujo</span></li>
                <li class="CentroEducacionaldeEnsinoSuperiordoAmazonas">Jaqueline  Melo <span>@jaqueemello</span></li>
                <li class="UniversidadedeSaoPaulo">Jemima Carvalho de Araújo <span>@jemimacarvalho_</span></li>
                <li class="UniversidadeFederaldoRiodeJaneiro">Jéssica  Cristina Gonçalves  <span>@jessicacristina.15</span></li>
                <li class="CentrouniversitarioarmandoAlvarespenteado-FAAP">João Pedro Hudson <span>@joaopedrohudson</span></li>
                <li class="CentrouniversitariodasAmericas">Julia  ramos dos santos <span>@Ju.ramoss</span></li>
                <li class="PontificiaUniversidadeCatolica">Júlia  Rodrigues <span>@Júlia_rds</span></li>
                <li class="UniversidadePaulista-UNIP">Júlia  Alves Bernardes <span>@julia_alves_bernardes</span></li>
                ...
                <li class="UEPA-UniversidadedoEstadodoPara-Reitoria">Larissa Thais dos Reis França <span>@larissathaisfranca_</span></li>
                ...
                <li class="UniversidadeFeevale">Leonardo Mendonça <span>@leo_pmendonca</span></li>
                ...
                <li class="UniversidadePresbiterianaMackenzie">Letícia  Gusmão Oliveira  <span>@_leticiagusmao</span></li>
                ...
                <li class="UniversidadeTecnologicaFederaldoParana">Maria Augusta Simões Sanchez Oliveira <span>@insta.guta</span></li>
                <li class="UniversidadeFederaldoTrianguloMineiro">Maria Eduarda  Guimarães da Costa <span>@duda_dacosta</span></li>
                ...
                <li class="UNIVERSIDADEESTADUALDOAMAZONAS">Miguel Cezar Silva Magalhães <span>@miguelcezarsm</span></li>
                ...
                <li class="Faculdademetropolitanasunidas">Natália  Pereira  <span>@eunaat</span></li>
                <li class="UniversidadePUC-Rio">Nathália  Gouveia <span>@natt_gouveia</span></li>
                ...
                <li class="CentroUniversitariodoEspiritoSanto">Suélen  Maier <span>@suelen_maier</span></li>
                <li class="UniversidadeSalgadodeOliveira">Symilla  Lino de Oliveira <span>@symillalino</span></li>
                <li class="Universitarioluteranadobrasil">Taís  Ventura <span>@taissventura</span></li>
                ...
                <li class="UNIGRAN-CentroUniversitariodaGrandeDourados">Vitória Moraes Bonito Silva <span>@vivi_bonito</span></li>
                <li class="UniversidadefederalFluminense">Vitória Torres <span>@vitoriadtorres</span></li>
                <li class="Centrouniversitarioluteranodepalmas">Vittória  Horner Nogueira  <span>@euhorner</span></li>
                <li class="UniversidadeEstadualdeCampinas">Viviane  Lourenco  <span>@vivi_slourenco</span></li>
                <li class="CentrouniversitarioFaculdadeGuanambi">Zaira  Antônia Lima Santana  <span>@zaira_santana.eng</span></li>
                ...
                <li class="Quito">Julio Proaño <span>@pockets_puce</span></li>
                ...
                <li class="CiudaddelEste">Óscar Manuel Bravo Álvarez <span>@pocketsupecde</span></li>
                ...
                <li class="MortonCollege">João Rosito <span>@jvrosito</span></li>
